...
- Checkout [v4 release](https://github.com/vulcanize/ipld-eth-server/tree/pm-v4-single-node) in ipld-eth-server repo.
  ```bash
  # In ipld-eth-server repo.
  git checkout pm-v4-single-node
  ```

- Checkout working commit in stack-orchestrator repo.
  ```bash
  # In stack-orchestrator repo.
  git checkout 0f4b58624ee7fc049ae25aeacced476ee9a4ca71
  ```
